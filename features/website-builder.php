...
<body class="bg-[#fafafa]" style="font-family: 'Inter', sans-serif;">
    ...
    <div class="relative bg-[#0b1120] overflow-hidden pt-24 pb-32">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2000"
                ...
                onerror="this.src='https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2000'">
        ...
        <div class="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl">
                <div
                    ...
                    <span class="text-sm font-medium text-blue-100">Digital Storefront</span>
                </div>
                <h1 class="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">Launch Your
                    Rental Storefront Instantly.</h1>
                <p class="text-xl text-gray-300 mb-10 leading-relaxed">Deploy a high-converting, SEO-optimised booking
                    website in seconds. Choose your theme, attach your domain, and start processing rentals immediately.
                </p>
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="bg-[#0b1120] rounded-3xl p-10 md:p-14 text-white shadow-2xl overflow-hidden relative">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-12 max-w-2xl">Powering the digital footprint of massive
                    fleets.</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-white/10 pt-8">
                    <div>
                        <div class="text-4xl font-bold mb-2">SSL</div>
                        <div class="text-gray-400 text-sm">Certificates auto-provisioned</div>
                    </div>
                    <div>
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <h2 class="text-4xl font-bold text-gray-900 mb-6 tracking-tight">Design. Publish.<br><span
                        class="text-blue-600">Convert.</span></h2>
                <p class="text-xl text-gray-600 leading-relaxed mb-6">Stop messing around with complex Wordpress
                    plugins. Our website builder is purpose-built for mobility operators to funnel traffic directly into
                    live inventory.</p>
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h4 class="text-lg font-bold text-gray-900">Custom Branding</h4>
                        <p class="mt-1 text-gray-600">Deeply integrate your primary colors, logos, and custom fonts
    ...
    <div class="bg-white py-24 border-t border-gray-100">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mt-2 mb-4">Subdomain or Custom Domain</h2>
                <p class="text-xl text-gray-600">Launch immediately on a free `.fleetrentalpro.com` subdomain, or map
                    your own premium domain (e.g., `www.yourbrand.com`) securely with one click.</p>
            </div>

            <div class="bg-[#0b1120] rounded-3xl p-8 lg:p-12 overflow-hidden relative shadow-2xl">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="relative z-10 text-white">
                        <h3 class="text-3xl font-bold mb-6">Subdomain or Custom Domain</h3>
                        <p class="text-gray-400 mb-8 max-w-md text-lg">Launch immediately on a free
                            `.fleetrentalpro.com` subdomain, or map your own premium domain (e.g., `www.yourbrand.com`)
                            securely with one click.</p>
                        <ul class="space-y-4">
    ...
    <div class="bg-[#fafafa] py-20">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">Next-Gen Marketing Features</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <h4 class="text-lg font-bold text-gray-900 mb-2">Analytics Integration</h4>
                    <p class="text-sm text-gray-600 leading-relaxed">Easily paste Google Analytics or Facebook Pixel IDs
                        to track your marketing conversion funnels.</p>
                </div>
                <!-- Card 2 -->
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    <div class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
    ...
    <div class="bg-white py-24" id="interactive-tabs-e51b6a08bcc5ef7a910d8c46fc5d75d5">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-16">Website Builder Configuration</h2>
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                ...
                <div
                    ...
                    <div class="absolute inset-0 tab-visual-img transition-opacity duration-700 opacity-100"
                        style="background-image: url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800'); background-size: cover; background-position: center;">
                    ...
                    <div class="relative z-10 p-10 flex flex-col justify-end h-full text-white">
                        ...
                        <h3 class="text-3xl font-bold mb-3 tab-visual-title tracking-tight">Launch Sequence</h3>
                        <p class="text-gray-200 text-lg leading-relaxed tab-visual-desc">Launch an optimised domain in
                            seconds built upon foundations mathematically optimised to convert casual visitors into
                    ...
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">1.
                                Theme Selection</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">Choose a
                                starter layout that fits your brand identity (luxury, economy, adventurous).</p>
                        </div>
                    </div> <!-- Interactive Step 1 -->
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="1"
                        data-image="https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">2.
                                Asset Upload</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">Upload your
                                logo and automatically sync your fleet images to the storefront.</p>
                        </div>
                    </div> <!-- Interactive Step 2 -->
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="2"
                        data-image="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">3.
                                Go Live</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">Connect
                                Stripe, map your custom domain, and begin accepting public bookings instantly.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const section = document.getElementById('interactive-tabs-e51b6a08bcc5ef7a910d8c46fc5d75d5');
                if (!section) return;
    ...
    <div class="py-24 text-center">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold text-gray-900 mb-6">Put flawless website builder into your fleet</h2>
    ...
    <section
        ...
        <div class="flex w-full flex-col items-start gap-3 text-left lg:items-center lg:gap-4 lg:text-center">
            ...
            <h2
                ...
                <span>Questions about</span> Website Builder
            </h2>
            ...
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(0)"
                    ...
                    <span
                        ...
                        is a car rental website builder?</span>
                    <div
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Our native website builder
                        is an integrated digital storefront engine designed explicitly for mobility businesses. It
                        allows you to drag-and-drop a premium, SEO-optimised, highly converting vehicle reservation
                        website directly mapped to your active inventory.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(1)"
                    ...
                    <span
                        ...
                        does the booking widget sync with my fleet inventory?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Because the storefront is
                        natively coupled with your administrative dashboard, the reservation checkout widget pulls live
                        vehicle availability with zero latency. If a car is dispatched locally, it instantly disappears
                        from your public storefront to prevent overbooking.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(2)"
                    ...
                    <span
                        ...
                        the generated website technically optimised for local SEO?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">The structural HTML is
                        rendered using next-generation performance heuristics. We automatically generate XML sitemaps,
                        inject canonical tags, and provide micro-data schema architectures allowing your rental agency
                        to rank dominantly for local competitive search terms.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(3)"
                    ...
                    <span
                        ...
                        I attach my own custom top-level domain name?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Yes. While we provide a
                        complimentary staging subdomain, you can seamlessly connect your bespoke `.com` domain. We
                        automatically provision and perpetually renew enterprise-grade SSL certificates to ensure all
                        booking traffic remains fully encrypted.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(4)"
                    ...
                    <span
                        class="text-[18px] font-semibold leading-[1.3] tracking-[-0.5px] text-[#1a1a1a] sm:text-[19px] sm:tracking-[-0.6px] md:text-[22px] md:tracking-[-0.8px] lg:text-[24px] lg:tracking-[-1px]">Is
                        the digital storefront optimised for mobile bookings?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Absolutely. Over 60% of
                        modern car reservations originate from mobile devices. Your generated website embraces deep
                        responsive scaling, providing massive tap targets, compressed imagery, and fluid navigation
                        specifically engineered to conversion-optimise smartphone traffic.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(5)"
                    ...
                    <span
                        ...
                        the website builder support Google Analytics and Meta Pixels?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Your marketing ecosystem
                        is heavily supported. You can instantaneously inject native tracking identifiers directly into
                        the builder interface, allowing you to meticulously record conversion funnels, execute
                        retargeting campaigns, and measure ROAS on your ad spend.</p>
                </div>
            </div>
        </div>
    </section>
