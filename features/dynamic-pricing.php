...
<body class="bg-[#fafafa]" style="font-family: 'Inter', sans-serif;">
    ...
    <div class="relative bg-[#0b1120] overflow-hidden pt-24 pb-32">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&q=80&w=2000"
                alt="Condition Reports Hero" class="w-full h-full object-cover opacity-30"
                onerror="this.src='https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&q=80&w=2000'">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl">
                <div
                    ...
                    <span class="text-sm font-medium text-blue-100">Revenue Optimization</span>
                </div>
                <h1 class="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">AI-Driven
                    Dynamic Pricing Algorithms.</h1>
                <p class="text-xl text-gray-300 mb-10 leading-relaxed">Maximise your fleet yield automatically. Our
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="bg-[#0b1120] rounded-3xl p-10 md:p-14 text-white shadow-2xl overflow-hidden relative">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-12 max-w-2xl">Boosting revenue across thousands of
                    vehicles.</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-white/10 pt-8">
                    <div>
                        <div class="text-4xl font-bold mb-2">24/7</div>
                        <div class="text-gray-400 text-sm">Automated adjustments</div>
                    </div>
                    <div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <h2 class="text-4xl font-bold text-gray-900 mb-6 tracking-tight">Analyse. Adjust.<br><span
                        class="text-blue-600">Maximise.</span></h2>
                <p class="text-xl text-gray-600 leading-relaxed mb-6">Don't leave money on the table. Set robust pricing
                    floors and ceilings, and let our algorithm handle the micro-adjustments that drive serious
                    profitability.</p>
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h4 class="text-lg font-bold text-gray-900">Length of Stay Multipliers</h4>
                        <p class="mt-1 text-gray-600">Automatically offer computed discounts for weekly or monthly
                            rentals.</p>
                    </div>
                </div>
                <div class="flex items-start">
    ...
    <div class="bg-white py-24 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mt-2 mb-4">Intelligent Rate Calendar</h2>
                <p class="text-xl text-gray-600">Visualise all your pricing rules overlaid directly onto your booking
                    calendar. Spot anomalies and override algorithmic suggestions instantly.</p>
            </div>

            <div class="bg-[#0b1120] rounded-3xl p-8 lg:p-12 overflow-hidden relative shadow-2xl">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="relative z-10 text-white">
                        <h3 class="text-3xl font-bold mb-6">Intelligent Rate Calendar</h3>
                        <p class="text-gray-400 mb-8 max-w-md text-lg">Visualise all your pricing rules overlaid
                            directly onto your booking calendar. Spot anomalies and override algorithmic suggestions
                            instantly.</p>
                        <ul class="space-y-4">
                            <li class="flex items-center text-gray-300">
                                ...
                                </svg> Historical year-over-year pacing data
                            </li>
                            <li class="flex items-center text-gray-300">
                                <svg class="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
    ...
    <div class="bg-[#fafafa] py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">Total control over your pricing strategy</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <h4 class="text-lg font-bold text-gray-900 mb-2">Lead Time Variables</h4>
                    <p class="text-sm text-gray-600 leading-relaxed">Increase prices for last-minute same-day bookings
                        to capture urgent demand.</p>
                </div>
                <!-- Card 2 -->
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    <div class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
    ...
    <div class="bg-white py-24" id="interactive-tabs-cb8c66f537c11acab460a2465dd98a43">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-16">Dynamic Pricing Configuration</h2>
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                ...
                <div
                    ...
                    <div class="absolute inset-0 tab-visual-img transition-opacity duration-700 opacity-100"
                        style="background-image: url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800'); background-size: cover; background-position: center;">
                    ...
                    <div class="relative z-10 p-10 flex flex-col justify-end h-full text-white">
                        ...
                        <h3 class="text-3xl font-bold mb-3 tab-visual-title tracking-tight">Pricing Execution</h3>
                        <p class="text-gray-200 text-lg leading-relaxed tab-visual-desc">Stop relying on static seasonal
                            rates. Unlock your potential with algorithmic adjustments mapped directly to actual lot
                            scarcity.</p>
                    </div>
                </div>
                    ...
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">1.
                                Rule Compilation</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">The system
                                constantly evaluates your base rates combined with your seasonal multipliers and
                                length-of-stay discounts.</p>
                        </div>
                    ...
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">2.
                                Scarcity Injection</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">Live
                                triggers inject percentage premiums based on exactly how many cars you have left on the
                                lot.</p>
                        </div>
                    </div> <!-- Interactive Step 2 -->
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="2"
                        data-image="https://images.unsplash.com/photo-1533750349088-cd871a92f312?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            ...
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">The
                                finalised intelligent rate is broadcast across your website and connected channels
                                instantly.</p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const section = document.getElementById('interactive-tabs-cb8c66f537c11acab460a2465dd98a43');
                if (!section) return;
    ...
    <div class="py-24 text-center">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold text-gray-900 mb-6">Put flawless dynamic pricing into your fleet</h2>
    ...
    <section
        ...
        <div class="flex w-full flex-col items-start gap-3 text-left lg:items-center lg:gap-4 lg:text-center">
            ...
            <h2
                ...
                <span>Questions about</span> Dynamic Pricing
            </h2>
            ...
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(0)"
                    ...
                    <span
                        ...
                        is dynamic pricing software for car rental fleets?</span>
                    <div
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Dynamic pricing is an
                        AI-driven revenue management tool that automatically adjusts your daily rental vehicle rates
                        based on supply, demand signals, seasonality, and fleet scarcity, allowing you to maximise
                        RevPAR (Revenue Per Available Rental).</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(1)"
                    ...
                    <span
                        ...
                        does fleet scarcity affect my daily rental rates?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Our algorithm continuously
                        monitors your active inventory. If your inventory drops below a preset threshold (e.g., 80%
                        utilization), the system triggers scarcity premiums, automatically raising prices on your
                        remaining vehicles to capture higher margins.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(2)"
                    ...
                    <span
                        ...
                        I set minimum and maximum price floors?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Yes. You maintain total
                        administrative control over the pricing engine. You can define strict minimum basement rates and
                        absolute maximum ceiling rates for every specific vehicle class, guaranteeing the AI never
                        underprices your premium assets.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(3)"
                    ...
                    <span
                        ...
                        the automated pricing engine account for weekends and holidays?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">The software natively
                        supports complex seasonal yielding. You can configure automated weekend percentage multipliers
                        and input localised high-demand date ranges (like music festivals or airport peaks) to surge
                        pricing precisely when demand spikes.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(4)"
                    ...
                    <span
                        ...
                        it possible to offer automated long-term rental discounts?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Our length-of-stay pricing
                        modifiers automatically calculate and present discounted weekly or monthly rates. This
                        incentivises longer bookings, which dramatically reduces your operational vehicle turnaround and
                        cleaning costs.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(5)"
                    ...
                    <span
                        class="text-[18px] font-semibold leading-[1.3] tracking-[-0.5px] text-[#1a1a1a] sm:text-[19px] sm:tracking-[-0.6px] md:text-[22px] md:tracking-[-0.8px] lg:text-[24px] lg:tracking-[-1px]">Can
                        I override the algorithmic pricing recommendations manually?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Of course. Through the
                        centralised rate calendar interface, fleet managers can perform bulk overrides to enforce static
                        pricing overrides on specific days, overpowering the dynamic adjustment algorithms when manual
