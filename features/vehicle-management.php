...
<body class="bg-[#fafafa]" style="font-family: 'Inter', sans-serif;">
    ...
    <div class="relative bg-[#0b1120] overflow-hidden pt-24 pb-32">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?auto=format&fit=crop&q=80&w=2000"
                alt="Condition Reports Hero" class="w-full h-full object-cover opacity-30"
                onerror="this.src='https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?auto=format&fit=crop&q=80&w=2000'">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl">
                <div
                    ...
                    <span class="text-sm font-medium text-blue-100">Asset Control</span>
                </div>
                <h1 class="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">The Ultimate
                    command center for your Fleet.</h1>
                <p class="text-xl text-gray-300 mb-10 leading-relaxed">Track everything from a single pane of glass.
                    Monitor servicing schedules, mileage limits, depreciation schedules, and real-time asset statuses
                    effortlessly.</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="bg-[#0b1120] rounded-3xl p-10 md:p-14 text-white shadow-2xl overflow-hidden relative">
            ...
            <div class="relative z-10">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mb-12 max-w-2xl">The backbone of intelligent fleet operations.
                </h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-white/10 pt-8">
                    <div>
                        <div class="text-4xl font-bold mb-2">Unlimited</div>
                        <div class="text-gray-400 text-sm">Vehicles supported</div>
                    </div>
                    <div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <h2 class="text-4xl font-bold text-gray-900 mb-6 tracking-tight">Track. Maintain.<br><span
                        class="text-blue-600">Scale.</span></h2>
                <p class="text-xl text-gray-600 leading-relaxed mb-6">Every vehicle has a story. Our system centralises
                    toll histories, damage reports, maintenance logs, and financial ROI against every individual VIN in
                    your fleet.</p>
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h4 class="text-lg font-bold text-gray-900">Status Automation</h4>
                        <p class="mt-1 text-gray-600">Vehicles automatically shift states to 'In Rental', '\Cleaning',
                            or 'Available' based on live data.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <div class="flex-shrink-0 mt-1">
    ...
    <div class="bg-white py-24 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mt-2 mb-4">Comprehensive Asset Profiles</h2>
                <p class="text-xl text-gray-600">A dedicated page for every car in your inventory documenting its
                    license plate, insurance expiration, high-res marketing photos, and current geolocation.</p>
            </div>

            <div class="bg-[#0b1120] rounded-3xl p-8 lg:p-12 overflow-hidden relative shadow-2xl">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="relative z-10 text-white">
                        <h3 class="text-3xl font-bold mb-6">Comprehensive Asset Profiles</h3>
                        <p class="text-gray-400 mb-8 max-w-md text-lg">A dedicated page for every car in your inventory
                            documenting its license plate, insurance expiration, high-res marketing photos, and current
                            geolocation.</p>
                        <ul class="space-y-4">
    ...
    <div class="bg-[#fafafa] py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">Protecting your investments</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    ...
                    <h4 class="text-lg font-bold text-gray-900 mb-2">Fleet Utilization Reports</h4>
                    <p class="text-sm text-gray-600 leading-relaxed">Generate CSV reports identifying which vehicle
                        classes are your top performers and which should be sold.</p>
                </div>
                <!-- Card 2 -->
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                    <div class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
    ...
    <div class="bg-white py-24" id="interactive-tabs-e633b627798940c35e3e9ccd20d17fc2">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-16">Vehicle Management Configuration</h2>
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                ...
                <div
                    ...
                    <div class="absolute inset-0 tab-visual-img transition-opacity duration-700 opacity-100"
                        style="background-image: url('https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?auto=format&fit=crop&q=80&w=800'); background-size: cover; background-position: center;">
                    ...
                    <div class="relative z-10 p-10 flex flex-col justify-end h-full text-white">
                        ...
                        <h3 class="text-3xl font-bold mb-3 tab-visual-title tracking-tight">Asset Lifecycle</h3>
                        <p class="text-gray-200 text-lg leading-relaxed tab-visual-desc">Monitor structural ROI and
                            safeguard your inventory via automated alerts surrounding registration and preventative
                            service markers.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col space-y-2 relative">
                    ...
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="0"
                        data-image="https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">1.
                                Fleet Onboarding</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">Input VINs
                                to automatically decode make, model, and specs. Upload baseline condition photos.</p>
                        </div>
                    </div> <!-- Interactive Step 1 -->
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="1"
                        data-image="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            ...
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">The vehicle
                                cycles through rentals, logging mileage, revenue, and generating necessary maintenance
                                flags.</p>
                        </div>
                    </div> <!-- Interactive Step 2 -->
                    <div class="relative flex items-start p-6 cursor-pointer rounded-2xl transition-all duration-300 hover:bg-gray-50 group tab-trigger"
                        data-idx="2"
                        data-image="https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&q=80&w=800">
                        ...
                        <div class="ml-6 flex-1">
                            <h4 class="text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 tab-title">3.
                                Defleeting</h4>
                            <p class="text-gray-500 leading-relaxed tab-text transition-colors duration-300">When
                                maximum mileage is reached, generate total lifetime ROI reports to maximise resale
                                pricing.</p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const section = document.getElementById('interactive-tabs-e633b627798940c35e3e9ccd20d17fc2');
                if (!section) return;
    ...
    <div class="py-24 text-center">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold text-gray-900 mb-6">Put flawless vehicle management into your fleet</h2>
    ...
    <section
        ...
        <div class="flex w-full flex-col items-start gap-3 text-left lg:items-center lg:gap-4 lg:text-center">
            ...
            <h2
                ...
                <span>Questions about</span> Vehicle Management
            </h2>
            ...
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(0)"
                    ...
                    <span
                        ...
                        does fleet vehicle management software track?</span>
                    <div
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Comprehensive fleet
                        software serves as your centralised operational command node. It continuously tracks critical
                        asset life-cycles, consolidating live geolocations, real-time odometer readings, active damage
                        heat-maps, and overarching ROI financials for every vehicle across your enterprise.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(1)"
                    ...
                    <span
                        ...
                        can I trace my vehicle maintenance and servicing schedules?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">The platform deploys
                        powerful preventative logistical triggers. Fleet managers can easily configure automated
                        warnings based on lapsed temporal intervals or precise telematics mileage milestones, ensuring
                        vital oil-changes and tire rotations are never overlooked.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(2)"
                    ...
                    <span
                        ...
                        I calculate the exact financial yield of an individual rental car?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Yes. Our sophisticated
                        ledger system aggregates holistic revenue streams exclusively tied to a specific VIN whilst
                        simultaneously deducting localised toll violations, structural repair acquisitions, and
                        insurance premiums to provide a razor-accurate, per-unit profitability margin.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(3)"
                    class="group flex w-full items-center justify-between gap-4 py-5 text-left transition-colors hover:opacity-80 sm:gap-6 sm:py-6 md:gap-10 md:py-7">
                    <span
                        class="text-[18px] font-semibold leading-[1.3] tracking-[-0.5px] text-[#1a1a1a] sm:text-[19px] sm:tracking-[-0.6px] md:text-[22px] md:tracking-[-0.8px] lg:text-[24px] lg:tracking-[-1px]">Does
                        the system proactively alert me to expiring vehicle registrations?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Manual spreadsheet
                        tracking leads to severe operational fines. Our infrastructure consistently monitors
                        bureaucratic deadlines, generating aggressive automated notifications 30-days preceding
                        structural insurance lapses or impending DMV registration expirations.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(4)"
                    ...
                    <span
                        class="text-[18px] font-semibold leading-[1.3] tracking-[-0.5px] text-[#1a1a1a] sm:text-[19px] sm:tracking-[-0.6px] md:text-[22px] md:tracking-[-0.8px] lg:text-[24px] lg:tracking-[-1px]">How
                        do I manage long-term vehicle depreciation and defleeting?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">Through advanced
                        logistical analytics, macroscopic metrics effortlessly identify which specific automotive assets
                        within your fleet are drastically underperforming regarding yielding capitalization. This
                        analytical insight empowers highly tactical, margin-preserving defleeting choices during the
                        resale cycle.</p>
                </div>
            </div>
            <div class="border-b border-[#e5e5e5] last:border-b-0">
                <button onclick="toggleFaq(5)"
                    ...
                    <span
                        class="text-[18px] font-semibold leading-[1.3] tracking-[-0.5px] text-[#1a1a1a] sm:text-[19px] sm:tracking-[-0.6px] md:text-[22px] md:tracking-[-0.8px] lg:text-[24px] lg:tracking-[-1px]">Can
                        I filter and group cars by specialised vehicle classes?</span>
                    <div
                        class="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#f5f5f7] transition-colors group-hover:bg-[#ebebed] sm:size-9 md:size-10">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="faq-content hidden overflow-hidden">
                    <p class="pb-5 text-[18px] text-gray-600 leading-relaxed sm:pb-6 md:pb-7">The inventory
                        infrastructure inherently supports highly nested categorization tagging. You can pool distinct
                        vehicles into explicit hierarchical classes, enabling customers to securely book a guaranteed
                        'Premium Luxury SUV' classification without committing to a specific, potentially unavailable
                        license plate.</p>
                </div>
            </div>
        </div>
