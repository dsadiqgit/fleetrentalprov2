...
<head>
    ...
    <title>Dealership Settings - <?= htmlspecialchars($tenant['name'])?></title>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <nav class="text-sm text-gray-500 mb-1">
                        ...
                        <span class="text-gray-900">Dealership</span>
                    </nav>
                    <h1 class="text-2xl font-bold text-gray-900">Company</h1>
                    <p class="text-sm text-gray-600 mt-1">Manage your business information</p>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-4 sm:p-6 lg:p-8">
            <div class="max-w-4xl">
                ...
                <div class="relative shrink-0 mb-6 sm:mb-8">
                    <div class="flex h-9 w-fit max-w-full items-center rounded-full border border-[rgba(120,120,128,0.05)] bg-[rgba(120,120,128,0.05)] p-1 select-none">
