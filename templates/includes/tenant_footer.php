...
// Fetch tenant settings for phone / WhatsApp
$pdo = getDB();
        ...
        <div class="grid md:grid-cols-4 gap-12 text-center md:text-left">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <p class="text-[10px] text-gray-600 font-bold uppercase tracking-widest mb-1">Phone</p>
                        <p class="text-gray-400 text-sm font-bold"><?= htmlspecialchars($company_phone ?: ($content['contact_phone'] ?? '+1 (555) 123-4567'))?></p>
                    </div>
                    <?php if ($whatsapp_enabled && !empty($whatsapp_number)): ?>
                    <div>
                        <p class="text-[10px] text-green-400 font-bold uppercase tracking-widest mb-1">WhatsApp</p>
                        <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $whatsapp_number)?>" target="_blank" rel="noopener noreferrer" class="text-gray-400 text-sm font-bold hover:text-green-400 transition"><?= htmlspecialchars($whatsapp_number)?></a>
                    </div>
                    <?php endif; ?>
                </div>
